...
/**
 * Opencart Turbo
 * Developed by Atomix & Bogdan
 * Version: BETA
 * http://www.atomix.com & http://www.bogdanf.ro
 *
...
define('GITHUB_URL','https://github.com/Bogdan-dev-code');
...
// Main Configuration
if (is_file(DIR_SYSTEM . 'config/main.php')) {
    require_once(DIR_SYSTEM . 'config/main.php');
}
...
?>
    ...
    <div class="container">
        <div class="well">
            ...
            <h2>Opencart Turbo<br>Developed by <a href="http://www.atomix.com.au">Atomix</a> & <a href="http://www.bogdanf.ro">Bogdan</a></a></h2>
